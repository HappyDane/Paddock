...
public class SettingsViewModel : INotifyPropertyChanged
{
    ...
    public bool QuickHideEnabled
    {
        ...
        set
        {
            _settings.Settings.QuickHideEnabled = value;
            _settings.Save();
            OnPropertyChanged();
        }
    }
    ...
    public bool SnapEnabled
    {
        ...
        set
        {
            _settings.Settings.SnapEnabled = value;
            _settings.Save();
            OnPropertyChanged();
        }
    }
    ...
    public double DefaultOpacity
    {
        ...
        set
        {
            _settings.Settings.DefaultOpacity = value;
            _settings.Save();
            OnPropertyChanged();
        }
    }
    ...
    public double DefaultCornerRadius
    {
        ...
        set
        {
            _settings.Settings.DefaultCornerRadius = value;
            _settings.Save();
            OnPropertyChanged();
        }
    }
